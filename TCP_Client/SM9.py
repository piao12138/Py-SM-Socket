...
dll = CDLL('D:\D\Documents\Desktop\Py-SM-Socket\sm9.dll')
...
class CryptSM9_Encryption(object):
    ...
    def encrypt(self, r_str, msg_bytes, mode='block'):
        try:
    ...
    def __get_cipher(self, ciphertext, mode):
        ...
        if mode == 'stream':
            ...
            if len(ciphertext) <= 128 + 64:
                print(
                    'The length of Ciphertext should be more than 192, now the length is ' + str(
                        len(ciphertext)) + '.\n')
                return False
    ...
    def decrypt(self, cipher, mode='block'):
        try:
...
class CryptSM9_Signature(object):
    def __init__(self, ks_str, id_str='Alice'):
    ...
    def verify(self, msg_bytes, h_str, S_str):
        try:
            Pub_str_list = self.Pub_str.split('\n')
            self.P_pub_s = construct_BNPoint2(Pub_str_list[0], Pub_str_list[1], Pub_str_list[2], Pub_str_list[3])
            ...
            msg_bytes = bytes(str_to_hex_list(msg_bytes))
            res = dll.DSA_Verify(byref(self.h2), self.h, self.S, msg_bytes, self.__id_str.encode(), self.P1, self.P2,
                                 self.P_pub_s)
            return res
...
if __name__ == '__main__':
    ...
    msg_bytes = "12345678900987654321"

    cipher = sm9_enc.encrypt(Ppub, msg_bytes)
    print("cipher: ", cipher, "\n")

    plaintext = sm9_enc.decrypt(cipher)
    print("plaintext: ", plaintext, "\n")

    sm9_sig = CryptSM9_Signature(plaintext)
    Ppub, ds = sm9_sig.generate_key()
    print('Ppub: ', Ppub, "\n")
    print('ds: ', ds, "\n")

    r = ""

    h, S = sm9_sig.sign(r, ds)
    print('h: ', h, "\n")
    print('S: ', S, "\n")

    res = sm9_sig.verify(r, h, S)
    print("res: ", res, "\n")
